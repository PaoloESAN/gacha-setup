...
description: Common questions and answers about Gacha Blender Setup
---
...
:::note[Placeholder]
Here will go additional questions and answers regarding model formats, licenses, and shader compatibility.
:::
