...
def rig_character(
    ...
    swap_const_follow_in_const(
        "MCH-ROT-head", "COPY_ROTATION", 'pose.bones["plate-settings"]["Head Follow"]', target_bone="torso.002"
    )
    swap_const_follow_in_const(
        "MCH-ROT-neck", "COPY_ROTATION", 'pose.bones["plate-settings"]["Neck Follow"]', target_bone="torso.002"
    )
